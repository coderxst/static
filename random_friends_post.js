"use strict";
var frdata = {
  apiurl: "https://friends.coderxst.top/",
  defaultFish: 100,
  hungryFish: 100
};
if ("undefined" != typeof frdataUser)
  for (var key in frdataUser)
    frdataUser[key] && (frdata[key] = frdataUser[key]);
  ...
  0 == randomPostWorking &&
    ...
    (randomPostWorking =
      (randomPostClick * frdata.hungryFish + frdata.defaultFish <
        randomPostTimes && 0 == Math.round(Math.random())
        ? (document.getElementById("random-post").innerHTML =
